  ...
  public String mygetString (String path){
    ...
    private final class DockReceiver extends BroadcastReceiver {
    	...
    	public void onReceive(Context context, Intent intent) {
    		...
    		if("1".equals(str)){
    			    Slog.d(TAG,"------------goToSleepNoUpdateLocked----111---");
    			    myHandler.sendEmptyMessage(0);
    			   // Message msg = mHandler.obtainMessage(MSG_SCREEN_BRIGHTNESS_BOOST_TIMEOUT);  
              //msg.setAsynchronous(true);  
              // mHandler.sendMessageAtTime(msg, SystemClock.uptimeMillis()+2000); 
    			   // Message msg = mHandler.obtainMessage(MSG_USER_ACTIVITY_TIMEOUT);
              //msg.setAsynchronous(true);
            ...
            // 	new Thread(){
						...
						//				try {
							...
							//					e.printStackTrace();
							//				}
											//goToSleepNoUpdateLocked(SystemClock.uptimeMillis(),PowerManager.GO_TO_SLEEP_REASON_TIMEOUT, 0,1000);
							//				goToSleepNoUpdateLocked(SystemClock.uptimeMillis(),PowerManager.GO_TO_SLEEP_REASON_POWER_BUTTON, 0,1000);
							//				Slog.d(TAG, "acquire() goToSleep");
						//				}
					//	}.start();

    				Slog.d(TAG,"------------goToSleepNoUpdateLocked----2222---");
    	 }
    	}
    }
