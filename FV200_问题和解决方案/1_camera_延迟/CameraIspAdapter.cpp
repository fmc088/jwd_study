...
void CameraIspAdapter::initDefaultParameters(int camFd)
{
    ...
    //previwe size and picture size
    {
        ...
        parameterString = "176x144,320x240,352x288,640x480,720x480,800x600,1280x720";
        ...
        params.set(CameraParameters::KEY_PREVIEW_SIZE,"800x600");
        params.set(CameraParameters::KEY_SUPPORTED_PREVIEW_SIZES, "176x144,320x240,352x288,640x480,720x480,800x600,1280x720");        
