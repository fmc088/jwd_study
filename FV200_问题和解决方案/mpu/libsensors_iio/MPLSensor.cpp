...
static struct sensor_t sSensorList[] =
{
    {(const char *)("MPL Gyroscope"), (const char *)("Invensense"), 1,
     ...
     SENSOR_TYPE_GYROSCOPE, 2000.0f, 1.0f, 0.5f, 10000, 0, 0, 0,0,0,0,0,0},
    {(const char *)("MPL Raw Gyroscope"), (const char *)("Invensense"), 1,
     SENSORS_RAW_GYROSCOPE_HANDLE,
     SENSOR_TYPE_GYROSCOPE_UNCALIBRATED, 2000.0f, 1.0f, 0.5f, 10000, 0, 0, 0,0,0,0,0,0},
    {(const char *)("MPL Accelerometer"), (const char *)("Invensense"), 1,
     SENSORS_ACCELERATION_HANDLE,
     SENSOR_TYPE_ACCELEROMETER, 10240.0f, 1.0f, 0.5f, 10000, 0, 0, 0,0,0,0,0,0},
    {(const char *)("MPL Magnetic Field"), (const char *)("Invensense"), 1,
     SENSORS_MAGNETIC_FIELD_HANDLE,
     SENSOR_TYPE_MAGNETIC_FIELD, 10240.0f, 1.0f, 0.5f, 10000, 0, 0, 0,0,0,0,0,0},
    ...
    {(const char *)("MPL Game Rotation Vector"), (const char *)("Invensense"), 1,
     ...
     SENSOR_TYPE_GAME_ROTATION_VECTOR, 10240.0f, 1.0f, 0.5f, 10000, 0, 0, 0,0,0,0,0,0},
    ...
    {(const char *)("MPL Geomagnetic Rotation Vector"), (const char *)("Invensense"), 1,
     ...
     SENSOR_TYPE_GEOMAGNETIC_ROTATION_VECTOR, 10240.0f, 1.0f, 0.5f, 10000, 0, 0, 0,0,0,0,0,0},
#endif
